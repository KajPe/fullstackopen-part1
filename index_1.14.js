...
class App extends React.Component {
  ...
  mostvotesindex = () => {
    return this.state.votes.reduce((iMax, x, i, arr) => x > arr[iMax] ? i : iMax, 0);
  }

  render() {
    const idx = this.mostvotesindex()
    return (
      <div>
        ...
        <br />
        <Mostvotes anecdote={this.props.anecdotes[idx]} cnt={this.state.votes[idx]} />
      </div>
    )
  }
}
